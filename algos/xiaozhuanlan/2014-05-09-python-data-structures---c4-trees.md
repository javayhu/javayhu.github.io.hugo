...
![image](http://owvzfqno0.bkt.clouddn.com/algos_bst_del_wiki.png)
...
![image](http://owvzfqno0.bkt.clouddn.com/algos_bst_pre.png)
...
![image](http://owvzfqno0.bkt.clouddn.com/algos_bst_later.png)
...
![image](http://owvzfqno0.bkt.clouddn.com/algos_bst_del1.png)

(2)如果结点z只有一个子树（左子树或者右子树），通过在其子结点与父节点建立一条链接来删除z。

![image](http://owvzfqno0.bkt.clouddn.com/algos_bst_del2.png)
...
![image](http://owvzfqno0.bkt.clouddn.com/algos_bst_del3.png)
...
![image](http://owvzfqno0.bkt.clouddn.com/algos_bst_worst.png)
...
![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_operations.png)

如何进行旋转

![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_rotate.png)

旋转的实现描述

![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_rotatedetails.png)
...
![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_bf.png)
...
![image](http://owvzfqno0.bkt.clouddn.com/algos_avl1.png)
![image](http://owvzfqno0.bkt.clouddn.com/algos_avl2.png)

(3)左旋，右旋以及左右旋和右左旋

左旋：如果新的根节点有左孩子结点，那么左孩子结点就成为原来的根节点的右孩子结点

![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_left.png)

右旋：如果新的根节点有右孩子结点，那么右孩子结点就成为原来的根节点的左孩子结点

![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_right.png)

一种特殊的情况，单一的左旋和右旋都不行，不停地重复交替，所以需要左右旋(或者右左旋)

![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_leftright.png)
![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_leftright2.png)

(4)如何在不重新计算子树的高度情况下修改旋转前的根节点和旋转后的根节点的平衡因子值

下面是左旋的例子

![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_rebal1.png)
![image](http://owvzfqno0.bkt.clouddn.com/algos_avl_rebal2.png)
...
![images](http://owvzfqno0.bkt.clouddn.com/algos_bst_avl.png)
